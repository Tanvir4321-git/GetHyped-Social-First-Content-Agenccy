  ...
  return (
    <section className='max-w-360 mx-auto pb-12.25 md:pb-18 mt-20 md:mt-30.5 px-4.25 md:px-7.5'>
      ...
      <div className='flex md:flex-row flex-col items-end gap-10'>
        ...
        <div className=" md:w-1/3 w-full  h-76.5 hidden md:block">

          <img loading="lazy" src="https://cdn.prod.website-files.com/6848603da8e6ac95794b7498/6894757aa6dd3f84f6e463a2_Anniek%20Bril.webp" alt="About team member" className="w-57.5 rounded-2xl h-full object-cover" />

        </div>

        {/* video for mobile */}

        <div className='md:w-1/3 w-full h-110.25 rotate-4 md:hidden '>

          <video className='w-80 h-full object-fill rounded-2xl ml-3'
        ...
        <div className="md:w-1/3 w-full  ">
          ...
          <p className="md:text-[23px] text-[21px] font-semibold text-[#161616] leading-7.5 mb-4.25">
            ...
            Zo weet je precies wat werkt en wat niet. Nooit meer content zonder strategie. Nooit meer content zonder resultaat.
        ...
        <div className="w-1/3 md:flex items-center justify-end pr-20 hidden ">
          ...
          <a href="#next-section" className="scroll-smooth">
            <span className="w-10 h-10 rounded-xl hover:rounded-lg transition-all duration-300 ease-in-out hover:-rotate-1 border border-black flex items-center justify-center cursor-pointer bg-transparent overflow-hidden group relative">
